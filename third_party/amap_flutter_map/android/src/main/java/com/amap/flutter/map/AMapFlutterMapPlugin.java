...
// Legacy v1 PluginRegistry imports removed; we use FlutterPlugin v2 APIs only
...
public class AMapFlutterMapPlugin implements
    ...
    // Keep v1 embedding compatibility for older apps; on modern Flutter this is unused but must compile
    // Removed legacy v1 embedding registration to support modern Flutter/AGP; v2 registration is handled by FlutterPlugin callbacks above.
